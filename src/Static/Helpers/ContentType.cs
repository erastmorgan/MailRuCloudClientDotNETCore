//-----------------------------------------------------------------------------------------------
// <copyright file="ContentType.cs" company="Erast Korolev">
...
namespace MailRuCloudClient.Static.Helpers
{
    ...
    /// <summary>
    /// Defines the content type helper.
    /// </summary>
    internal static class ContentType
    {
        ...
        /// The MIME types list.
        /// </summary>
        private static readonly IDictionary<string, string> MimeTypesList = new Dictionary<string, string>(StringComparer.CurrentCultureIgnoreCase)
        {
            {
                ".323",
                "text/h323"
        ...
        /// <returns>The computed content type.</returns>
